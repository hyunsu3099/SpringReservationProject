...
package com.springreservation.web.controller.reservation;
...
public class ReservationController {
    ...
    public String reservation(){
        return "all.reservation.reservation";
    }

    @GetMapping("/list")
    public String list(){
        return "all.reservation.list";
    }

    //index 페이지에서 표 상태 요청했을 때
    //firstday 형식 : String "yyyyMMdd", 시작날짜로부터 6일간 예약상태 반환
    @GetMapping("/status")
